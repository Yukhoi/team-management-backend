...
@Component
@Order(10)
public class PlayerCreatedParser implements AuditEventParser {

    private static final String EVENT_TYPE = "player.created";

    private final ObjectMapper objectMapper;

    public PlayerCreatedParser(ObjectMapper objectMapper) {
