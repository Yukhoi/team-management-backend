...
public class OpponentAnalysisMetricsController {
    ...
    @Operation(
            ...
            description = "Fetches the match context, local FLA mappings and live FLA standings, then returns Java-calculated metrics only."
    )
